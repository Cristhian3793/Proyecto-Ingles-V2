...
namespace PagosVarios.LoginDb
{
    public static class Conexion
    {
        ...
        public static string GuardaTransaccion(string Cedula, string Importe, string Iva, string NombreFactura, string TipoIdenFactura, string IdentificacionFactura, string TelefonoFactura, string DireccionFactura, string CorreoFactura, string ip, int esAlumno)
        {
            ...
            try
            {
                //if (int.Parse(ds3.Tables[0].Rows[0][0].ToString()) > 0)
                //{
                //    if (ds.Tables[0].Rows.Count > 0)
                //    {
                //DataSet ds2 = BuscarNAV_ds("[TransaccionesBotonPagosOnline]", "top 1 *", " where cedula='" + Cedula + "' and  Estado<>'Pagado' and  Estado<>'Negado' and  Estado<>'Autorizado' order by fecha desc, hora desc");
                //if (ds2.Tables[0].Rows.Count > 0)
                //{
                //    mens2 = actualizarNAV("TransaccionesBotonPagosOnline", "Secuencial='" + Secuencial + "',Fecha='" + fecha + "',Hora='" + hora + "',Importe='" + Importe + "'" +
                //        ",Estado='En Proceso',NombreFactura='" + NombreFactura + "',IdentificacionFactura='" + IdentificacionFactura + "',TelefonoFactura='" + TelefonoFactura + "'" +
                //        ",DireccionFactura='" + DireccionFactura + "',CorreoFactura='" + CorreoFactura + "',TipoIdenFactura='" + TipoIdenFactura + "',IVA='" + Iva + "'," +
                //        "D_datos='',[D_aut]='',D_Cre='',D_Mes=0,D_ttar='',D_sub=0,D_Iva=0,D_Ice=0,D_Int=0,D_Tot=0,D_tNo='',D_cDt='',D_Tipo='',EsAlumno='" + esAlumno + "',lote='',Referencia='' ",
                //        " where Secuencial='" + ds2.Tables[0].Rows[0]["secuencial"] + "'");
                //}
                //else
                //{
                ...
                ",[D_datos],[D_aut],[D_Cre],[D_Mes],[D_ttar],[D_sub],[D_Iva],[D_Ice],[D_Int],[D_Tot],[D_tNo],[D_cDt],[D_Tipo],numtransaccion,EsAlumno,lote,Referencia";
                ...
                sqlValores = "'" + Secuencial + "','" + Cedula + "','" + fecha + "','" + hora + "'," + Importe + ",'" + Estado + "','" +
                    +ProcesadaCaja + "','" + Firmada + "','" + NombreFactura + "','" + IdentificacionFactura + "','" + TelefonoFactura + "','" + DireccionFactura +
                            "','" + CorreoFactura + "'," + TipoIdenFactura + "," + Iva + ",'','','',0,'',0,0,0,0,0,'','','','" + (int.Parse(ds3.Tables[0].Rows[0][0].ToString()) + 1) + "','" + esAlumno + "','',''";
                ...
                //                ",DireccionFactura='" + DireccionFactura + "',CorreoFactura='" + CorreoFactura + "',TipoIdenFactura='" + TipoIdenFactura + "',IVA='" + Iva + "'," +
                //                "D_datos='',[D_aut]='',D_Cre='',D_Mes=0,D_ttar='',D_sub=0,D_Iva=0,D_Ice=0,D_Int=0,D_Tot=0,D_tNo='',D_cDt='',D_Tipo='',EsAlumno='" + esAlumno + "',lote='',Referencia=''",
                //                " where Cedula='" + Cedula + "' and  ( Estado<>'Pagado' or  Estado<>'Negado' or Estado<>'Autorizado')");
                //    }
                //}
                //else
                //{
                ...
                //    sqlValores = "'" + Secuencial + "','" + Cedula + "','" + fecha + "','" + hora + "'," + Importe + ",'" + Estado + "','" +
                //        +ProcesadaCaja + "','" + Firmada + "','" + NombreFactura + "','" + IdentificacionFactura + "','" + TelefonoFactura + "','" + DireccionFactura +
                //                "','" + CorreoFactura + "'," + TipoIdenFactura + "," + Iva + ",'','','',0,'',0,0,0,0,0,'','','','1','" + esAlumno + "','',''";
        ...
        public static string GuardarMaestroDeposito(string id, List<Producto> listaCompras)
        {
            ...
            {
                int cant = 0;
                DeleteNAV("Maestrodeposito_online", "where secuencial='" + id + "'");
                foreach (Producto x in listaCompras)
                {

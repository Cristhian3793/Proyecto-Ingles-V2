<%@ Page Title="" Language="C#" MasterPageFile="~/Interfaces/Site.Master" AutoEventWireup="true" CodeBehind="formLicencias.aspx.cs" Inherits="Proyecto_Ingles_V2.Interfaces.formLicencias" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                     ...
                     <h4 class="well" style="background-color:rgb(8, 83, 148);color:white;text-align:center">Licencias Cambridge</h4>
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="cbxLibros" runat="server" AutoPostBack="true" class="form-control" >
                                                </asp:DropDownList>
                                        </div>
                                     </div>                                                                 
                                    <div class="form-group col-sm-6">

	...
	<div class="row">
        <div class="col-sm-12">
                                ...
                                <asp:Label ID="Label2" runat="server" Text="Cod Nivel"></asp:Label>
                                 ...
                                 <div class="col-xs-2">
                                    <div class="form-group">
                                    <asp:DropDownList ID="cbxSearchNiveles" AppendDataBoundItems="true" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="cbxSearchNiveles_SelectedIndexChanged">
                            ...
                            <div class="span4"> 
                                <asp:HiddenField id="idTipoNivel" runat="server"/>
                                 ...
                                 <div class="form-group col-sm-6">                                            
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtCodNivel" runat="server" CssClass="form-control" 
                                             TabIndex="4" ValidationGroup="val4" required="true"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">                                            
                                ...
                                <div class="form-group col-sm-6">                                            
                                    ...
                                    <div class="controls">
                                    <asp:DropDownList ID="cbxLibros"  runat="server" class="form-control">
                                   </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">                                            
                                    ...
                                    <div class="controls">
                                       ...
                                       TabIndex="4" ValidationGroup="val4"  required="true" onkeypress="return NumCheck(event, this)"></asp:TextBox>
                                    </div>
                                </div>
                              </div>
                        </div>

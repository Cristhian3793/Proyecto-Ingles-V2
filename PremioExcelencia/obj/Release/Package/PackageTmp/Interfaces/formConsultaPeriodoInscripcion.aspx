...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="padding-left: 10%; padding-right: 10%; width: 100%">
        <h4 class="well" style="background-color: rgb(8, 83, 148); color: white; text-align: center">Consulta Períodos Prueba de Ubicación</h4>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelModal" runat="server" Style="display: none; background: white; width: 40%; height: auto; border: solid 1px black">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button class="btn btn-primary" ID="btnactualizar" runat="server" Text="Guardar Cambios"  OnClick="btnActualizar_Click" />
                </div>
            </asp:Panel>
    ...
    <script>
        ...
        function error_fechas() {
            Swal.fire({
                icon: 'error',
                title: 'error',
                text: 'La fecha inicio debe ser menor que la fecha fin',
                footer: '<a href></a>'
            })
        }

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="dgvNivel" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="false" DataKeyNames="idNivel" CssClass="table table-bordered table-striped" OnRowCommand="dgvTema_RowCommand" PageSize="10" AllowPaging="true" OnPageIndexChanging="dgvNivel_PageIndexChanging" >
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Button" Text="Temas Nivel" CommandName="Editar" />
                                    </Columns>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelModal2" runat="server" Style="display: none; background: white; width: 50%; height: auto; border: solid 1px black">
                    ...
                    <div class="container-fluid well">
                        <div class="row-fluid">
                            <div class="span4">
                                ...
                                <div class="form-group col-sm-12">
                                    <asp:GridView ID="dgvTemaUnidad" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered table-striped"  DataKeyNames="idNomUnidad" OnRowDeleting="dgvTemaUnidad_RowDeleting">
                                        <Columns>

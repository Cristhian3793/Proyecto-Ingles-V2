    ...
    <div class="container" style="padding-left: 10%; padding-right: 10%;">
        ...
        <div class="col-lg-12 well">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="IDPREGUNTA" CssClass="table table-bordered table-striped" OnRowCommand="GridView1_RowCommand" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting">
                        <Columns>
                            ...
                            <ControlStyle BackColor="#2568A3" BorderStyle="Outset" CssClass="btn btn-sm" ForeColor="White" />
                            </asp:ButtonField>
